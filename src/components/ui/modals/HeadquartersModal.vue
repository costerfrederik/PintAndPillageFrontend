    ...
    <div class="headquartersFrame">
        ...
        <div class="headquartersContainer headquartersEditVillageNameContainer">
            ...
            <div class="headquartersEditVillageNameInputContainer">
                <input class="inputField" type="text" v-model.trim="newVillageName" placeholder="New Village Name" />
    ...
    methods: {
        ...
        updateVillageName: function () {
            if (this.validateForm()) {
                ...
                this.$store
                    .dispatch('updateVillageName', { newVillageData: newVillageData, villageId: villageId })
                    .then(() => {
