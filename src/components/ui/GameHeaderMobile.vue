<template>
    <div class="headerMobile">
        ...
        <div class="buttonDivMobile">
            <button class="mapButtonMobile" @click="showWorldMap" :class="{ villageButton: isOnWorldMap }"></button>
            ...
            <button v-bind:class="fetchLogButtonCssClass()" @click="showModalAndUpdateNewLogAvailableToFalse('Logs')"></button>
        </div>
    </div>
</template>
