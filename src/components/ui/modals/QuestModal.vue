<template>
    <div class="questModal" v-if="currentQuest">
        <div class="questComponents">
            ...
            <div v-for="objectives in currentQuest.objectives" :key="objectives.key" class="objectiveList">
                <p :style="[objectives.isCompleted ? { textDecoration: 'line-through' } : { textDecoration: 'none' }]">
            ...
            <button :disabled="!currentQuest.isCompleted" @click="finishQuest" class="baseButton" id="questButton">Collect Reward</button>
        </div>
    </div>
