<template>
    <div class="outerOfferContainer">
        <div style="display: flex; flex-direction: row; justify-content: center; height: 120px">
            ...
            <resource-selector v-if="resources" :resources="Object.keys(resources)" @selectedUpdate="offerResource = $event"></resource-selector>
            <img
            ...
            />
            <div class="inputContainer">
                <input v-model="acceptanceAmount" type="number" min="0" @keypress="validateNumberInput(999999, $event)" />
            </div>
            <resource-selector v-if="resources" :resources="building.allResourceTypes" @selectedUpdate="tradeResource = $event"></resource-selector>
        </div>
