    ...
    <div class="travelsContainer scrollerFirefox">
        ...
        <div v-if="building.marketTravels" class="offerListTravels">
            <div v-for="travel in building.marketTravels" :key="travel.key" class="travelRow">
                ...
                <p style="margin-left: 91px" v-if="travel.traveltimeLeft">Traveltime: {{ travel.traveltimeLeft }} {{ travel.acceptanceResource }}</p>
                <img
                    ...
                    height="28px"
                />
                <img v-else src="../../../assets/ui-items/outgoingArrow.png" class="travelArrow" width="42px" height="28px" />
            </div>
        </div>
