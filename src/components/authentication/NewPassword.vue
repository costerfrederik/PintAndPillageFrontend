    ...
    <div class="newPassowrd" @keydown.enter="resetPassword">
        <div class="newPasswordBox">
            <div class="newPasswordInputBox">
                ...
                <input class="inputField" id="newPasswordInputField1" type="password" v-model.trim="password" placeholder="Password" />
                <input class="inputField" id="newPasswordInputField2" type="password" v-model.trim="repeatPassword" placeholder="Repeat password" />
                <button class="submitButton" id="newPasswordButton" @click="resetPassword">Reset password</button>
            </div>
        </div>
    </div>
</template>
