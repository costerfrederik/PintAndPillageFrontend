<template>
    <div v-if="this.properties.villageData" class="scrollerFirefox">
        <ul v-if="unitMovementHasData()" class="unitMovementList">
            <h2 v-if="incomingAttacksHasData()" id="attackingYouTitle">Careful, you are about to be attacked by the following troops</h2>
            <li v-for="(attack, index) in this.properties.villageData.incomingAttacks" v-bind:key="'inAttack' + index">
                ...
                <div class="travelAndArrow">
                    ...
                    <img class="TravelArrows" src="../../../assets/ui-items/arrows/incommingAttackArrow.png" />
                </div>
            </li>
            <h2 v-if="outgoingAttacksHasData()">Your attacking troops</h2>
            <li v-for="(attack, index) in this.properties.villageData.outgoingAttacks" v-bind:key="'outAttack' + index">
                <div class="travelingUnits">
            ...
            <li v-for="(travel, index) in this.properties.villageData.returningCombatTravels" v-bind:key="'travel' + index">
                <ul class="resourcesTravelArrowAndUnits">
                    <li>
                        ...
                        <div class="travelAndArrow">
                            ...
                            <img class="TravelArrows" src="../../../assets/ui-items/arrows/incommingOwnTroopsArrow.png" />
                        </div>
                    </li>
                    <li class="units">
                        <div class="travelingUnits">
                            <div v-for="(unit, index) in travel.travelingUnits" v-bind:key="'travel-unit' + index">
                                <p>{{ unit.unit.unitName }}: {{ unit.amount }}</p>
                            </div>
                        </div>
                    </li>
...
export default {
    ...
    methods: {
        unitMovementHasData: function () {
            ...
            const dataAmount = villageData.incomingAttacks.length + villageData.outgoingAttacks.length + villageData.returningCombatTravels.length;
            return dataAmount > 0;
        },
