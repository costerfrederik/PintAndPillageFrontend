    ...
    <div :class="{ disabledResearchOverlay: !researchLevelRequirementMet() }">
        <div class="researchBox">
            <div class="researchTitle">
                <img :src="require('../../assets/ui-items/' + research.researchName + '.png')" width="35px" height="28px" />
...
export default {
    ...
    methods: {
        researchLevelRequirementMet: function () {
            ...
            let villageresources = this.$store.getters.resources;
        ...
        startResearch: function (researchType) {
            let research = { researchBuildingId: this.buildingId, researchType: researchType };
