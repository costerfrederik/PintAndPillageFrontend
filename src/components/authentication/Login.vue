<template>
    ...
    <div v-else>
        <div class="uncompatibleBrowser">
            ...
            <h1>Hi there,</h1>
            <h3>
                We are detecting that you are currently not using a compatible browser for this application. This is really annoying right? Well blame
                Internet Explorer for not joining in the latest trends and features of modern browsers. If you want to enjoy the spoils of Pint and
                Pillage head over to Chrome, Firefox or Edge. We look forward to your pillaging! <br /><br />
                Regards, <br />
                <br />
