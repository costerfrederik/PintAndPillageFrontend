    ...
    <div v-if="scout" class="scoutModal">
        <div class="scoutFrame">
            ...
            <div class="scoutUnitFrame">
                <img :src="require('../../../assets/ui-items/' + scout.unit.unitName + '.png')" width="49px" height="42px" />
            ...
            <h2 v-if="showErrorNoScoutsSelected" style="color: #ca3e14">Please select at least 1 scout</h2>
...
export default {
    ...
    methods: {
        setScoutUnit: function () {
            let unitsList = this.$store.getters.village.unitsInVillage;
