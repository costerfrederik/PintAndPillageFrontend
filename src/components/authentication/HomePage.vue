            ...
            <div class="homePage">
                ...
                <div class="homepageContent">
                    <div class="sliderHomePageDiv">
                        <slider animation="fade" v-model="sliderValue" :interval="5000" :speed="1000" class="sliderHomePage">
                            <sliderItem v-for="(i, index) in list" :key="index" @click="changeIndex(1)">
                    ...
                    <div class="homePageText">
                        <p>
                            Welcome to Pint and Pillage, a real time strategy and massive multiplayer online game set in the time of the Vikings.
                            <br /><br />

                            Create your own village, upgrade your buildings and create massive armies to pillage all others.
                            <br /><br />
                            Register now to Pint and Pillage!
                        </p>
                    </div>
                </div>
            </div>
